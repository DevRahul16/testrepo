...
#               echo "pc3 ansible_host=${aws_instance.pc3.private_ip} ansible_user=ubuntu ansible_ssh_private_key_file=~/.ssh/Ammu.pem" >> /etc/ansible/hosts
#               EOF
